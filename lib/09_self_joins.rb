...
def craiglockhart_and_tollcross
  ...
  execute(<<-SQL)
    ...
    JOIN
      ...
      AND start_routes.num = end_routes.num
    JOIN 
      stops AS starting_stops ON starting_stops.id = start_routes.stop_id
    JOIN 
      stops AS end_stops ON end_stops.id = end_routes.stop_id
    WHERE  
      starting_stops.name = 'Craiglockhart'
...
def start_at_craiglockhart
  ...
  execute(<<-SQL)
    ...
    JOIN 
      stops AS end_stops ON end_routes.stop_id = end_stops.id
    JOIN 
      stops AS first_stops ON first_stops.id = start_routes.stop_id
    WHERE
      first_stops.name = 'Craiglockhart';
  SQL
end
